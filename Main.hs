...
--   tests = [
--     ("1+2", NumZ 3), ("1.0 + 2.1", NumR 3.1), ("   0. + 0.1   + 0.2 -  .3", NumR (0.0+0.1+0.2-0.3)), -- basic arithmetic, spaces
--     ("5 + -4 - (5 - 4)", NumZ 0), ("-pi", NumR (-pi)), ("--pi", NumR pi), ("-1^2", NumZ 1), ("-5!", NumZ (-120)), -- unary minus
...
--     ("2.0-1.0", NumR 1.0), ("2.0-1/2", NumR 1.5), ("1/2.0-1", NumR (-0.5))
--     ]
